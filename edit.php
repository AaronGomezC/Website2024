<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=='GET'){
    ...
    $sql = "update products set name='$name', price='$price', url='$url' where id='$id'";
    $result = $conn->query($sql);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" class="fw-bold">
      <div class="container-fluid">
        <a class="navbar-brand" href="table.php">PHP CRUD OPERATION</a>
 ...
 <label> URL: </label>
 <input type="text" name="url" value="<?php echo $url; ?>" class="form-control"> <br>
